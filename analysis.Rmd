...
pca_sub <- filter(df_pc, srch_destination_id == 187693281 | srch_destination_id == 81374 | srch_destination_id == 187809593)
...
```{r, ggplot2}
load(file="int.RData")
int_comb <- left_join(int_datasub, dest)
```